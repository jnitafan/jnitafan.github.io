...
const About = () => {
  return (
    <>
      ...
      >
        Hi, I'm Jacob. Thanks for checking out my portfolio. I specalize in
        front-end development, focused on creating websites of all different
        types. Take a look around to see my work history and the things I have
        created and been a part of so far.
      </motion.p>
